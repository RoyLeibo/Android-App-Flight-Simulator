...
public class JoyStickClass extends SurfaceView implements SurfaceHolder.Callback, View.OnTouchListener
{
    ...
    public JoyStickClass(Context theContext, AttributeSet attributes, int style)
    {
    ...
    public JoyStickClass (Context theContext, AttributeSet attributes)
    {
    ...
    public JoyStickClass(Context theContext)
    {
        super(theContext);
        getHolder().addCallback(this);
        setOnTouchListener(this);
    ...
    private void drawJoystick(float newX, float newY)
    {
        if(getHolder().getSurface().isValid())
        {
            ...
            thisCanvas.drawColor(0x2FC89F);
            //Draw the base first before shading
            colors.setARGB(255, 0, 255, 255);
